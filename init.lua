...
-- Set terminal title so Ghostty shows a useful tab name.
vim.o.title = true
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- keymap to jump to definition using telescope
			vim.keymap.set("n", "gd", smart_telescope_launch(builtin.lsp_definitions), { desc = "Goto [D]efinition" })
			-- keymap to go back from definition using gb
			vim.keymap.set("n", "gb", "<C-t>", { desc = "Go [B]ack from definition" })
			...
			vim.keymap.set(
				"n",
				"<leader>ss",
				smart_telescope_launch(builtin.builtin),
				{ desc = "[S]earch [S]elect Telescope" }
			)
			vim.keymap.set(
				"n",
				"<leader>sw",
				smart_telescope_launch(builtin.grep_string),
				{ desc = "[S]earch current [W]ord" }
			)
			vim.keymap.set(
				"n",
				"<leader>sg",
				smart_telescope_launch(builtin.live_grep),
				{ desc = "[S]earch by [G]rep" }
			)
			vim.keymap.set(
				"n",
				"<leader>sd",
				smart_telescope_launch(builtin.diagnostics),
				{ desc = "[S]earch [D]iagnostics" }
			)
			vim.keymap.set("n", "<leader>sr", smart_telescope_launch(builtin.resume), { desc = "[S]earch [R]esume" })
			-- rn map to rename symbol using telescope
			vim.keymap.set("n", "<leader>rn", vim.lsp.buf.rename, { desc = "LSP rename" })
			vim.keymap.set(
				"n",
				"<leader>s.",
				smart_telescope_launch(builtin.oldfiles),
				{ desc = '[S]earch Recent Files ("." for repeat)' }
			)
			-- command z to press u key
			...
			vim.keymap.set(
				"n",
				"<leader><leader>",
				smart_telescope_launch(builtin.resume),
			...
			vim.keymap.set(
				"n",
				"<leader>/",
				smart_telescope_launch(function()
